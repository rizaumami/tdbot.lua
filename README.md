...
`tdbot.lua` is a _Work In Progress_. This commit is based on [telegram-bot-171023-nightly.tl](https://valtman.name/files/telegram-bot-171023-nightly.tl) scheme.  
